...
public interface Missions
{
    ...
    static Mission getMission(FightAgent[] fightAgents)
    {
        ...
        index=427;gameObject=getRandomResourceCollectible();;gridMap.place(index, gameObject);
        index=278;gameObject=getRandomResourceCollectible();;gridMap.place(index, gameObject);
        index=381;gameObject=getRandomResourceCollectible();;gridMap.place(index, gameObject);
        index=512;gameObject=getRandomResourceCollectible();;gridMap.place(index, gameObject);
        index=533;gameObject=getRandomResourceCollectible();;gridMap.place(index, gameObject);
        index=897;gameObject=getRandomResourceCollectible();;gridMap.place(index, gameObject);
        index=878;gameObject=getRandomResourceCollectible();;gridMap.place(index, gameObject);
        ...
        index=365; gameObject=getRandomFightAgentCollectable();
        gridMap.place(index, gameObject);
...
//        index=749; gameObject=new FightTrigger()
    ...
    private static ResourceCollectible getRandomResourceCollectible()
    {
        ...
        ResourceType resourceType=ResourceType.values()[Math.round((float) Math.random()*(ResourceType.values().length-1))];
    ...
    private static FightAgentCollectable getRandomFightAgentCollectable()
    {
        ...
        FightAgent fightAgent = director.make(FightAgentDirector.calculateType(Allegiance.BLACK, FightAgentType.QUEEN, Faction.values()[Math.round((float) Math.random()*(Faction.values().length-1))], 1));
