...
public class FightAgentCollectableSerializer implements JsonSerializer<FightAgentCollectible>, JsonDeserializer<FightAgentCollectible>
{
    @Override
    public FightAgentCollectible deserialize(JsonElement src, Type type,
