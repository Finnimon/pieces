 ...
 * @since 10.05.2024
 */
public class WeightedGraph<Vertex extends com.gitgud.graph.Vertex, Element>
        extends Graph<Vertex, Element, WeightedEdge<Vertex>>
{
    /**
     ...
     * @Precondition: All Vertices in {@param edges} are in {@param vertices} also and the other way around and their
     * indexing is intact.
